...
export async function onRequestPost({ request, env }) {
  try {
    ...
    const SECRET_KEY = env.TURNSTILE_SECRET_KEY || "replace-with-your-turnstile-secret";
...
// Site Key: replace-with-your-turnstile-site-key
// Backend Endpoint: /api/verify
// ============================================================================

export const TURNSTILE_SITE_KEY = 'replace-with-your-turnstile-site-key';
...
Para que el widget con Site Key `replace-with-your-turnstile-site-key` valide correctamente en producción sin el error *Troubleshoot*, debe tener configurados en **dash.cloudflare.com > Turnstile > Widget Settings > Domains**:
