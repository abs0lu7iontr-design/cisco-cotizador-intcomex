...
class GravityDesktopApp:
    ...
    def run_cli_demo(self):
        ...
        print(" 1) mskill    (Rol: ADMINISTRADOR - Mauricio Skill)")
        print(" 2) madasme   (Rol: ESTÁNDAR - M. Adasme)")
        print(" 3) rcuevas   (Rol: ESTÁNDAR - R. Cuevas)")
        print(" 4) jvalancia (Rol: ESTÁNDAR - J. Valancia)")
        print("Contraseña por defecto: Intcomex2026!\n")

        # Simulate login as mskill (Admin)
        success, msg = self.auth.login("mskill", "Intcomex2026!")
