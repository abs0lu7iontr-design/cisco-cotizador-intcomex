...
-- =============================================================================
-- INICIALIZACIÓN DE USUARIOS BASE (ejemplo)
-- La contraseña real debe configurarse con variables de entorno o el primer inicio.
-- =============================================================================

INSERT INTO users (id, username, full_name, email, password_hash, role) VALUES
('usr-001-admin', 'mskill', 'System Administrator', 'admin@yourcompany.example', 'change-me-before-use', 'admin'),
('usr-002-std', 'madasme', 'Product Manager', 'pm1@yourcompany.example', 'change-me-before-use', 'standard'),
('usr-003-std', 'rcuevas', 'Product Manager', 'pm2@yourcompany.example', 'change-me-before-use', 'standard'),
('usr-004-std', 'jvalancia', 'Product Manager', 'pm3@yourcompany.example', 'change-me-before-use', 'standard')
