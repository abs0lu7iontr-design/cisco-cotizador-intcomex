...
export const APP_THEMES: AppTheme[] = [
  ...
  {
    id: 'blackened-graphite',
    name: 'Blackened Graphite',
    category: 'Executive & Minimal',
    description: 'Interfaz negra de alto contraste con grafito, blanco mineral y acento cyan para trabajo prolongado.',
    swatchColors: ['#050505', '#22d3ee', '#a3e635'],
    cssVars: {
      '--bg-app': '#050505',
      '--bg-panel': '#0b0d0e',
      '--bg-card': '#121516',
