...
export function UserManagementView() {
  ...
  const [newPassword, setNewPassword] = useState('change-me-before-use');
  ...
  const [resetPasswordVal, setResetPasswordVal] = useState('change-me-before-use');
  ...
  const handleSaveEditUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editPassword.trim()) {
        ...
        passwordHash = await sha256Salted('change-me-before-use');
      }
  ...
  const handleChangeRole = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedRecord: CloudUserRecord = {
        ...
        role: targetRole,
        password_hash: (selectedUserForAction as any).password_hash || (await sha256Salted('change-me-before-use')),
  ...
  const handleToggleStatus = async (user: UserRecord) => {
    ...
    try {
      ...
      const updatedRecord: CloudUserRecord = {
        ...
        email: user.email,
        role: user.role,
        password_hash: (user as any).password_hash || (await sha256Salted('change-me-before-use')),
                        ...
                        <div className="inline-flex items-center space-x-1.5">
                          ...
                          <button
                            onClick={() => {
                              ...
                              setResetPasswordVal('change-me-before-use');
